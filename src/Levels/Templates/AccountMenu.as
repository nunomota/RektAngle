package Levels.Templates {
	...
	public class AccountMenu extends Level {
		...
		public function AccountMenu(engine:GameEngine) {
			super(engine);
		}
		...
		protected override function setup():void {
			...
			addTexture("../Resources/Textures/Menus/Titles/AccountTitle.png");
		...
		protected override function start():void {
			...
			title = instantiate("AccountTitle", new Vector2D(canvas.dimensions.x/2, canvas.dimensions.y/16));
